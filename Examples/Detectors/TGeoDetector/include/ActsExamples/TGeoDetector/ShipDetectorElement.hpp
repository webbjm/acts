...
class ShipDetectorElement : public Acts::DetectorElementBase {
 ...
 private:
  ...
  /// the straw bounds
  std::shared_ptr<const Acts::LineBounds> m_elementLineBounds = nullptr;
};

inline const Acts::Surface& ShipDetectorElement::surface() const {
  return *m_elementSurface;
}

inline Acts::Surface& ShipDetectorElement::surface() {
  return *m_elementSurface;
}

inline double ShipDetectorElement::thickness() const {
  return m_elementThickness;
}

inline const Acts::Transform3& ShipDetectorElement::transform(
    const Acts::GeometryContext& gctx) const {
...
inline const Acts::Transform3& ShipDetectorElement::nominalTransform(
    const Acts::GeometryContext& /*gctx*/) const {
  return *m_elementTransform;
}

inline void ShipDetectorElement::addAlignedTransform(
...
ShipDetectorElement::alignedTransforms() const {
